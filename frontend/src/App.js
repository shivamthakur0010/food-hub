    ...
    <Router>
      ...
      <main className="app">
        <Switch>
          ...
          <Route exact path="/products/fastfood" component={DermotologyScreen}/>
          <Route exact path="/products/southindian" component={DepressionScreen}/>
          <Route exact path="/products/indianfood" component={DentalScreen} />
          <Route exact path="/products/shake" component={FractureScreen} />
          <Route exact path="/products/deserts"component={WomensCareScreen}/>
